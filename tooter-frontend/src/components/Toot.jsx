        ...
        <div className={styles.container}>
            ...
            <div className={styles.interaction}>
                <div className={styles.likeCon}>
                    <button className={styles.button}><img className={styles.like} src="/like.png"/></button>
                    {toot.likes.length}
                </div>
                <div className={styles.commentCon}>
                    <button className={styles.button}><img className={styles.comment} src="/comment.png"/></button>
